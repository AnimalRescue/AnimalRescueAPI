...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AnimalBreeds :  IEquatable<AnimalBreeds>
    {         /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AnimalBreeds)obj);
        }

        /// <summary>
        /// Returns true if AnimalBreeds instances are equal
        /// </summary>
        /// <param name="other">Instance of AnimalBreeds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimalBreeds other)
        {
            ...
            return 
                (
                    CatBreeds == other.CatBreeds ||
                    CatBreeds != null &&
                    CatBreeds.Equals(other.CatBreeds)
                ) && 
                (
                    DogBreeds == other.DogBreeds ||
                    DogBreeds != null &&
                    DogBreeds.Equals(other.DogBreeds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (CatBreeds != null)
                    hashCode = hashCode * 59 + CatBreeds.GetHashCode();
                    if (DogBreeds != null)
                    hashCode = hashCode * 59 + DogBreeds.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(AnimalBreeds left, AnimalBreeds right)
        {
